...
twitch_miner = TwitchChannelPointsMiner(
    username="ilovegambling3",
    password="Nicehatnowwdie",           # If no password will be provided, the script will ask interactively
    ...
    logger_settings=LoggerSettings(
        ...
        discord=Discord(
            webhook_api="https://discord.com/api/webhooks/1125592725761302589/zWA6xmHTEe1BTYvJ2uYpqdTObDy-cmv0qOR2_ySsa7-D6IDwF0JCAqTEsIOzw_GDGQy2",  # Discord Webhook URL
